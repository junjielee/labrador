...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('period', models.DateField(default=datetime.date(2016, 11, 8), unique=True, verbose_name='Record period')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=b'L', max_length=1, verbose_name='Room status', choices=[(b'L', 'Lived'), (b'E', 'Empty')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, max_length=1, verbose_name='Tenant sex', choices=[(b'M', 'Male'), (b'F', 'Female')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('add_time', models.DateTimeField(default=datetime.datetime(2016, 11, 8, 13, 27, 54, 63965), verbose_name='Add time')),
                ('update_time', models.DateTimeField(default=datetime.datetime(2016, 11, 8, 13, 27, 54, 64033), verbose_name='Update time')),
            ],
        ),
        migrations.CreateModel(
            name='Record',
            fields=[
                ...
                ('special_fee', models.IntegerField(default=0, verbose_name='Specail fee')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('move_out_date', models.DateField(null=True, verbose_name='Move out date', blank=True)),
        ...
        migrations.AlterUniqueTogether(
            name='record',
            unique_together=set([('room', 'period', 'tenant')]),
        ),
    ]
